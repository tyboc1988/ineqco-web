                ...
                <form action="" method="POST" autocomplete="off">
                    ...
                    <div class="field is-grouped">
                        <p class="control is-expanded">
                            <input class="input is-rounded" type="text" name="txt_buscador" placeholder="¿Qué estas buscando?" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ .]{1,80}" oninput="this.value = this.value.toUpperCase()" maxlength="30">
                        </p>
                        <p class="control">
        ...
        <div class="columns">
            <div class="column">
                <form class="has-text-centered mt-6 mb-6" action="" method="POST" autocomplete="off">
                    ...
                    <p>Estas buscando <strong>“<?= $_SESSION['busqueda_usuario'] ?>”</strong></p>
                    <br>
